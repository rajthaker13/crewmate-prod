      ...
      {!isMobile && (
        <div className="login">
          ...
          <div className="landing-page-1">
            <FadeIn delay={200}>
              <div>
                <h1 className="landing-page-big-text">
                  Careers Pages are Boring
                </h1>
              </div>
            </FadeIn>
            <FadeIn delay={1000}>
              <h1 className="landing-page-big-text-faded">
                Launch a Talent Community
              </h1>
            </FadeIn>
            <FadeIn delay={2000}>
              <div style={{ marginTop: "2%" }} key="2">
                <h3 className="landing-page-medium-text">
                  Upgrade your careers page with an embedded talent community
                </h3>
                <h3 className="landing-page-medium-text">
                  that enables you to engage, retain, and monetize your
                  applicant pool.
                </h3>
              </div>
            </FadeIn>
            <FadeIn delay={2000}>
              <div className="landing-page-button-row">
                <button
                  ...
                  onClick={talentCommunityLogin}
                >
                  <h3 className="landing-page-button-text">Get Started</h3>
                </button>
                <button
                  className="landing-page-button-grey"
                  onClick={() => {
                    window.open(
            ...
            <FadeIn delay={2000}>
              <img
                className="ss1"
                src={require("../../assets/nikeTC.jpg")}
              ></img>
            </FadeIn>
          </div>
          <div className="landing-slide-1">
            <h2 className="landing-slide-1-header">
              More features to power-up your talent brand
            </h2>
            <div className="landing-slide-1-card-container ">
              <div className="landing-slide-1-card">
                ...
                <h3 className="landing-slide-1-card-text">
                  Applicants interact with your content & learn more about your
                  talent brand. Crewmate offers AI-powered talent communities
                  with generative job searching and a virtual recruiter curated
              ...
              <div className="landing-slide-1-card">
                ...
                <h3 className="landing-slide-1-card-text">
                  See real-time occupations and social accounts of members in
                  your talent community and how they fit for open positions at
                  your brand.
                </h3>
              </div>
              <div className="landing-slide-1-card">
                ...
                <h3 className="landing-slide-1-card-text">
                  Unleash the purchasing power of your applicant pool through
                  trackable talent community offers on top products and
                  services.
                </h3>
              </div>
            </div>
        ...
        <div className="login-mobile">
          ...
          <div className="landing-page-1" style={{ minHeight: "50vh" }}>
            <FadeIn delay={200}>
              <div>
                <h1
                  className="landing-page-big-text"
            ...
            <FadeIn delay={1000}>
              <h1
                className="landing-page-big-text-faded"
                style={{ fontSize: "30px", lineHeight: "50px" }}
              >
                Launch a Talent Community
              </h1>
            ...
            <FadeIn delay={2000}>
              <div style={{ marginTop: "2%" }} key="2">
                <h3
                  className="landing-page-medium-text"
                  style={{
                    fontSize: "20px",
                    height: "auto",
                    marginBottom: "5vh",
          ...
          <div
            className="landing-slide-1"
            style={{ justifyContent: "center", alignItems: "center" }}
          >
            <h2
              className="landing-slide-1-header"
              style={{
                fontSize: "18px",
                textAlign: "center",
                marginLeft: "0px",
            ...
            <div
              className="landing-slide-1-card-container"
              style={{
