    ...
    return (
        <>
            ...
            <div style={{ display: 'inline-flex', }}>
                <div style={{ backgroundColor: '#1fd1f9', height: '88vh', width: '20vw', backgroundImage: 'linear-gradient(315deg, #1fd1f9 0%, #b621fe 74%)', borderRadius: '20px', overflow: 'auto', justifyContent: 'center', marginRight: '1vw' }}>
                    ...
                    <div className="container_requests">
                        ...
                        {incoming != false && incoming.map((user) => {
                            return (
                                <ProfileCard profileRec={user} mini={true} addConversation={addConversation} />
                            )
                        })}
                        <div style={{ height: '3vh' }} />
                    </div>
                ...
                <div style={{ backgroundColor: '#2a2a72', height: '88vh', width: '20vw', backgroundImage: 'linear-gradient(315deg, #2a2a72 0%, #009ffd 74%)', borderRadius: '20px', overflow: 'auto', justifyContent: 'center' }}>
                    ...
                    <div className="container_requests">
                        ...
                        {outgoing != false && outgoing.map((user) => {
                            return (
