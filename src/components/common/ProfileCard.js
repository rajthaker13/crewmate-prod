...
function ProfileCard({
  ...
  return (
    <div className="card_profile">
      ...
      >
        <img
          className="crewmate_profile_icon"
          src={profileRec.data?.logo_url}
      ...
      >
        <FaPeriscope
          color="#FAFAFA"
          size={25}
          className="crewmate_location_icon"
        />
      ...
      {!outgoing && (
        ...
        >
          <button
            className="add_to_crew_button"
            onClick={mini ? onAccept : onAdd}
          >
            <div
              style={{
                flexDirection: "row",
