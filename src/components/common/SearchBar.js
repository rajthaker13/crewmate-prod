  ...
  async function chatGPTDude() {
    if (props.isInputField) {
      ...
      const experienceText =
        "I am looking for jobs in " +
        props.location +
        " and I want the job to do this: " +
        userText +
        " and this is my Prior Work Experience of user: " +
        props.experience;
  ...
  return (
    <ClickAwayListener onClickAway={handleClickAway}>
      <div
        className={
          isMobile
            ? `search-bar-mobile ${expanded ? "expanded" : ""}`
        ...
        style={{
          ...
          borderWidth: "20px",
          outlineColor: "#9E9E9E",
          marginLeft: props.isInputField ? "0%" : "3%",
        }}
      >
        {!props.isInputField && (
          <button
        ...
        <textarea
          placeholder={
            expanded
              ? ""
              : props.isInputField
              ? "Type a message to Crewmate's Virtual Assistant"
              : "Type a few sentences about yourself, your goals, your interests, and what type of opportunities you are looking for here..."
          }
          rows={expanded ? 3 : 1}
          onClick={handleClick}
          className={
            isMobile ? "search-bar-input-new-mobile" : "search-bar-input-new"
          }
          value={userText}
          onChange={(e) => {
