  ...
  return (
    <>
      {isSearchingModal ? (
        ...
        <div className={isMobile ? "modal-mobile" : "modal"}>
          <h1 className="generate_modal_header">Enter your LinkedIn URL</h1>
          <div
            className={
              isMobile
          ...
          >
            <textarea
              className="generate_text_input-mobile"
              value={url}
              onChange={(e) => {
                setUrl(e.target.value);
              }}
              placeholder="https://www.linkedin.com/in/firstNameLastName/"
            />
          </div>
