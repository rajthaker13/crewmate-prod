...
function Bucket({ jobRecs, isFirstBucket = false, profileRec = {}, isSearching, experienceRecs }) {
            ...
            {isFirstBucket ?
                <>
                    ...
                    <div>
                        ...
                        <div className="container">
                            <div style={{ height: '3vh' }} />
                            {experienceRecs && experienceRecs.map((job, index) => {
                                return (
                                    <JobCard job={job} index={index} xs={80} isSearching={isSearching} />
                ...
                <div>
                    ...
                    <div className="container">
                        <div style={{ height: '3vh' }} />
                        {!isSearching && profileRec != false && <ProfileCard profileRec={profileRec} />}
                        <div style={{ height: '3vh' }} />
                    </div>
